...
class MainActivity : AppCompatActivity(), View.OnClickListener {
   ...
   public fun check() {
       ...
       if ((winnerPlayer!=1)&&(winnerPlayer!=2) &&(button1.text!=""&& button2.text!=""&& button3.text!=""&& button4.text!=""&& button5.text!=""&& button6.text!=""&& button7.text!=""&& button8.text!=""&& button9.text!="")) {
                    winnerPlayer=3
    ...
    fun resetclick(clickedView: View)   {
        ...
        button8.text=""
        button9.setBackgroundColor(MAGENTA)
        button9.text=""
