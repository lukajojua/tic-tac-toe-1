...
class MainActivity : AppCompatActivity(), View.OnClickListener {
   ...
   public fun check() {
       ...
       if ((winnerPlayer!=1)&&(winnerPlayer!=2) &&((button1.isEnabled==false) && (button2.isEnabled==false) && (button3.isEnabled==false) && (button4.isEnabled==false) && (button5.isEnabled==false) && (button6.isEnabled==false) && (button7.isEnabled==false) && (button8.isEnabled==false) && (button9.isEnabled==false))){
                    winnerPlayer=3
        ...
        if (winnerPlayer != 0) {
            ...
            if (winnerPlayer==3){
                Toast.makeText(this, "Neither of you won!", Toast.LENGTH_LONG).show()
